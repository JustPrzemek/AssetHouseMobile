...
import com.zebra.rfid.assethouse.adapters.AreasAdapter;
import com.zebra.rfid.assethouse.R;
import com.zebra.rfid.assethouse.api.service.AreaService;
...
public class AreasActivity extends AppCompatActivity {
    ...
    private class FetchAreasTask extends AsyncTask<Void, Void, List<Area>> {
        @Override
        ...
        protected void onPostExecute(List<Area> areas) {
            ...
            adapter.updateAreas(areas != null ? areas : new ArrayList<>());
