package com.zebra.rfid.assethouse.api.service;

import android.content.Context;

import com.zebra.rfid.assethouse.api.ApiClient;
...
public class AreaService {
    ...
    public List<Area> getAreas(String location, int page, int size) throws Exception {
